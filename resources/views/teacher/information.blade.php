                        ...
                        <form action="{{ url('add-information') }}" method="post">
                            ...
                            <div class="row justify-content-center align-items-center g-3 mb-3">
                                <div class="col">
                                    ...
                                    <select class="form-select" name="prefix"  aria-label="Default select example">
                                        <option selected  value="{{$data->prefix_name}}">--คำนำหน้าชื่อ--</option>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="firstname" id="firstname" value="{{$data->first_name}}" class="form-control">
                                </div>
                                <div class="col">
                            ...
                            <div class="row justify-content-center align-items-center g-2 mb-3">
                                <div class="col">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="datepicker" name="birthdays" class="form-control " value="{{$data->birthdays}}">
                                    </div>
                                </div>
                                <div class="col">
                                    <label for="symbol" class="form-label">สัญลักษณ์</label>
                                    <select class="form-select" name="symbol" value="{{$data->symbol}}">
                                        <option selected >--สัญลักษณ์--</option>
                            ...
                            <div class="row justify-content-center align-items-center g-2 mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" name="parents1" id="parents1" class="form-control" value="{{$data->parents1}}">
                                </div>
                                <div class="col">
                            ...
                            <div class="row justify-content-center align-items-center g-3 mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" name="telephonenumberparents1" id="telephonenumberparents1"
                                        class="form-control" value="{{$data->telephone_number_parents1}}">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="telephonenumberparents2" id="telephonenumberparents2"
                                        class="form-control" value="{{$data->telephone_number_parents2}}">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="telephonenumberbus" id="telephonenumberbus"
                                        class="form-control" value="{{$data->telephone_number_bus}}">
                            ...
                            <div class="row justify-content-center align-items-center g-2 mb-3">
                                <div class="col">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" name="habitations" rows="3" >{{$data->habitations}}</textarea>
                                </div>
